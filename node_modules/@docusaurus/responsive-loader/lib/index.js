...
module.exports = function loader(content) {
  ...
  if (config.disable) {
    ...
    return loaderCallback(null, 'module.exports = Object.assign(Object.create({toString(){return this.src;}}),{srcSet:' + publicPath + ',images:[{path:' + publicPath + ',width:100,height:100}],src: ' + publicPath + '});');
  }
  ...
  return img.metadata().then(metadata => {
    ...
    const firstImage = files[0]; // prevent toString from injected into {...img} or JSON.stringify
    // Object.assign is to avoid verbose syntax in Object.create; __proto__ is shorter but deprecated

    loaderCallback(null, 'module.exports = Object.assign(Object.create({toString(){return this.src;}}),{' + 'srcSet:' + srcset + ',' + 'images:[' + images + '],' + 'src:' + firstImage.path + ',' + 'placeholder: ' + placeholder + ',' + 'width:' + firstImage.width + ',' + 'height:' + firstImage.height + '});');
